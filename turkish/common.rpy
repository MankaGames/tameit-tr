translate turkish strings:
    ...
    new "Kaydetmediginiz tum ilerleme kaybolacak.\nBunu yapmak istedigine emin misin?"

    # renpy/common/00gui.rpy:378
    old "Are you sure you want to quit?"
    new "Cikmak istedigine emin misin?"

    # renpy/common/00gui.rpy:379
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "Ana menuye donmek istedigine emin misin?\nKaydedilmemis ilerlemen kaybolacak."
    ...
    new "Failed to save screenshot%.0s"

    # renpy/common/00keymap.rpy:312
    old "Saved screenshot as %s."
    new "Saved screenshot%.0s"
