translate turkish strings:
    ...
    new "Hmm, güzel. Yeterince saglam gorunuyor. En azından koruma saglar."

    # game/dicts/task.rpy:2
    old "{e=smiley}{e=bonfire}{e=exclamation_white}{e=smiling_face}"
    new "Harika, ates hazır. Umarım bu gece rahat uyurum."

    # game/dicts/task.rpy:2
    old "{e=slightly_smiling_face}{e=bungalow1}{e=check_mark}{e=smiling_face}"
    new "Tamam, çerçeveler hazır ve saglam gorunuyor. Simdi sıra duvarlarda."

    # game/dicts/task.rpy:2
    old "{e=bungalow2}{e=slightly_smiling_face}"
    new "Ohh, duvarlar neredeyse hazır."

    # game/dicts/task.rpy:2
    old "{e=bungalow3}{e=check_mark}{e=question}{e=thinking_face}"
    new "Hmm, ev neredeyse hazır ama sanırım bir seyi unuttum..."
    ...
    new "Hmm, Cat yatagı sevmis gibi gorunuyor. Umarım artık burda benimle yatar."

    # game/dicts/task.rpy:633
    old "{e=smiley}{e=gallows}{e=exclamation_white}{e=smiling_face}"
    new "Harika, tuzak hazır!"

    # game/dicts/task.rpy:633
    old "{e=thinking_face}{e=gallows}{e=plus}{e=poultry_leg}{e=question}"
    new "Tamam, simdi yem koyma zamanı. Bu kus etleri isimi görecektir."

    # game/dicts/task.rpy:633
    old "{e=bridge}{e=check_mark}{e=smiling_face}"
    new "Köprü hazır! Çok alengirli bir sey degil ama, isimi görecektir, yani umarım."

    # game/dicts/task.rpy:2
    old "{e=leavesbed}{e=ok_hand}{e=yawning_face}"
    new "Simdi en azından iyi kötü bir yatagım var."

    # game/dicts/task.rpy:634
    old "{e=gallows_2}{e=check_mark}{e=slightly_smiling_face}{e=arrow_right}{e=fish}"
    new "Yeni tuzagım hazır. Tek yapmam gereken biraz yem koymak."

    # game/dicts/task.rpy:634
    old "{e=thumbs_up}{e=smiley}{e=grappling}{e=arrow_up}"
    new "Ise yaradı. Simdi kancamı oraya atmayı denemeliyim."

    # game/dicts/task.rpy:703
    old "{e=gallows_2}{e=check_mark}{e=slightly_smiling_face}{e=arrow_right}{e=fish}{#ch04}"
    new "Pekala tuzak hazır simdi sıra yemde. Cat balıgı seviyor, o zaman ona büyük bir balık veriyim."

    # game/dicts/task.rpy:703
    old "{e=lake_trap}{e=yes}{e=slightly_smiling_face}"
    new "Tuzak hazır, heh pek kolay olmadı."
    ...
    new "Tamam, insa bitti ve artık evim  daha buyuk!"

    # game/dicts/task.rpy:2
    old "{e=slightly_smiling_face}{e=basin1}{e=yes}{e=smiling_face}"
    new "Fena degil! Ilk asamayı tamamladım sayılır."
    ...
    new "Tamaam, havuz hazır! Iyı görünüyor.\nUmarım Octa da sever."

    # game/dicts/task.rpy:939
    old "{e=boat}{e=yes}{e=smiley}{e=arrow_right}{e=cave}"
    new "Harika! Kayıgım denize acılmaya hazır."

    # game/dicts/task.rpy:965
    old "{e=halberd_head}{e=sparkles}{e=thumbs_up}"
    new "Iste, kız gibi oldu valla! Simdi kenarları keskin ve parlak!"

    # game/dicts/task.rpy:965
    old "{e=halberd_head}{e=plus}{e=halberd_shaft}{e=arrow_right}{e=halberd}"
    new "Bunu gercek bir savascı baltasına cevirmek için saglam bir sap yapmam lazım."
    ...
    new "Tabanı hazır ve su üzerinde oldukça dengeli görünüyor.\nIyi is çıkardım!"

    # game/dicts/task.rpy:2
    old "{e=tent}{e=thumbs_up}{e=raft_2}{e=yes}"
    new "Kulübe tamam. Artık bizi rüzgardan ve yagmurdan koruyacak."

    # game/dicts/task.rpy:2
    old "{e=storage}{e=yes}{e=beaming_face}"
    new "Pekala, kaynakları tasımak için bir kutumuz var,"

    # game/dicts/task.rpy:2
    old "{e=pot_of_food}{e=plus}{e=coconut_bowl_water}{e=arrow_right}{e=storage}"
    new "simdi onu su ve yiyecekle doldurmalıyım."

    # game/dicts/task.rpy:2
    old "{e=raft_4}{e=yes}{e=thumbs_up}{e=slightly_smiling_face}"
    new "Tamam, yelkeni de taktım. Iyi görünüyor."

    # game/dicts/task.rpy:2
    old "{e=raft}{e=yes}{e=smiley}{e=sparkles}"
    new "Her sey gerçekten bitti mi? Inanamıyorum!"
    ...
    new "O parlayan mantarlardan sifalı bir merhem yapmayı hatırlamam gerek."

    # game/dicts/task.rpy:2
    old "{e=boat}{e=ok_hand}{e=hourglass}{e=arrow_right}{e=desert island}"
    new "Adadan ayrılmak için her sey hazır."

    # game/dicts/task.rpy:1283
    old "{e=jaguar_skin_raw}{e=thumbs_up}"
    new "Fena degil! Yıllar önce büyükbabam bana tavsanları nasıl yüzecegimi göstermisti. "

    # game/dicts/task.rpy:1283
    old "{e=teach}{e=brain}{e=crafting}{e=jaguar_skin}"
    new "Bu bilgiyi kullanacagımı hiç düsünmemistim."
    ...
    new "Harika! Artık kagıdım var"

    # game/dicts/task.rpy:1283
    old "{e=paper}{e=cave}{e=arrow_right}{e=draw}{e=map}"
    new "Artık kagıdım olduguna göre magaraya geri dönüp haritayı kopyalayabilirim."
