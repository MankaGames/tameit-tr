translate german strings:
    ...
    new "Es hat in letzter Zeit geregnet, ich bin jetzt weniger durstig."
    ...
    new "Und die %s sind wieder weg. Ist es %s, die es stiehlt?"

    # game/classes/character.rpy:343
    old "And again, some of the %s is missing. That is %s's work, obviously."
    new "Und schon wieder, etwas %s fehlt. Das ist Ganz sicher %s's verdienst"
