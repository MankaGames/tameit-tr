...
translate russian scene_sleep_chapter09_d6aaeb6f:
...
translate russian strings:
    ...
    new "Стоит поискать бритву в самолёте. Вдруг повезёт."

    # game/scenes/chapter09/sleep.rpy:38
    old "{e=berries}{e=arrow_right}{e=shaving_foam}{e=thinking_face}"
    new "Может попробовать сделать из ягод пену для бритья?"
