...
translate russian strings:
    ...
    new "Может выпустить их в\u00A0хижине? Будут летать и\u00A0красиво светиться."
...
translate russian get_map_piece_85d641f3:
    ...
    lee_think "Что это за штука? Ни разу ещё не находил такой."

# game/scenes/common/collectibles.rpy:381
translate russian get_map_piece_e7e94bc0:

    # lee_think "{e=stone_tablet}{e=exclamation_white}{e=arrow_right}{e=inventory}"
    lee_think "И снова такая штука! Интересно, для чего они?"
