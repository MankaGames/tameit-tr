translate russian strings:
    ...
    new "Ну вот, копьё готово!"

    # game/dicts/craft.rpy:2
    old "{e=thinking_face}{e=spear}{e=wild_hen}{e=crab}"
    new "Теперь я смогу охотиться. Наконец-то буду есть что-то более питательное."

    # game/dicts/craft.rpy:2
    old "{e=lever}{e=yes}{e=slightly_smiling_face}"
    new "Рычаг готов! Я могу освободить Кошку!"

    # game/dicts/craft.rpy:2
    old "{e=smiley}{e=fishnet}{e=yes}{e=exclamation_white}"
    new "Ну вот, сеть готова! Время поохотиться на чудовище!"

    # game/dicts/craft.rpy:2
    old "{e=shaving_foam}{e=check_mark}{e=smiley}"
    new "Ну вот, готово! Вроде получилось неплохо."

    # game/dicts/craft.rpy:2
    old "{e=shovel}{e=yes}{e=exclamation_white}{e=smiley}"
    new "Супер! Лопата готова, теперь дело пойдёт гораздо быстрее!"
